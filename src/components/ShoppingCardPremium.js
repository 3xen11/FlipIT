...
const ShoppingCardPremium = ({ shoppingPackage, content }) => {
  console.log(shoppingPackage);

  return (
    <div className=" w-80 xl:w-96 bg-[url('/svg/pricingCardBackgroundDark.svg')] bg-cover h-[450px]  p-4  flex flex-col items-center relative bg-opacity-90 text-white hover:scale-105 transition-all shadow-lg">
