const AppFlashCard = () => {
  return (
    <div className=" bg-[url('/svg/pricingCardBackgroundDark.svg')] bg-cover relative w-3/5 max-w-xl h-80 rounded-xl bg-red-500 flex items-center justify-center overflow-hidden transition-all hover:shadow-lg hover:transform hover:-rotate-1 hover:scale-110">
