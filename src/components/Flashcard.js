  ...
  return (
    ...
    >
      <div className="card-inner w-full h-full transition-transform duration-500">
        <div className=" card-front absolute h-full w-full flex items-center justify-center text-center  rounded-xl shadow-lg bg-[url('/svg/pricingCardBackground.svg')] bg-cover text-white font-bold tracking-wide">
